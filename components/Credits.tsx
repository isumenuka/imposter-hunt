                ...
                <div className="relative z-10">
                    ...
                    <div className="text-center mb-8">
                        <div className="flex items-center justify-center mb-4">
                            <div className="p-4 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl border border-purple-500/30 animate-pulse">
                                <Gamepad2 size={48} className="text-purple-400" strokeWidth={2.5} />
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="text-center space-y-2">
                            ...
                            <div className="relative inline-block">
                                ...
                                <div className="relative bg-gradient-to-r from-purple-500 to-pink-500 text-white font-black text-2xl px-6 py-3 rounded-xl shadow-xl">
                                    isumenuka
                                </div>
                            </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-sm">
                                <div className="flex items-center gap-2 bg-white/5 rounded-lg px-3 py-2 border border-white/10 hover:border-purple-500/30 transition-colors">
                                ...
                                <div className="flex items-center gap-2 bg-white/5 rounded-lg px-3 py-2 border border-white/10 hover:border-blue-500/30 transition-colors">
                                    <Code2 size={18} className="text-blue-400" />
                                    <span className="text-slate-300">TypeScript</span>
                                </div>
                                <div className="flex items-center gap-2 bg-white/5 rounded-lg px-3 py-2 border border-white/10 hover:border-green-500/30 transition-colors">
                        ...
                        <div className="text-center space-y-3 pt-4">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg transition-all hover:scale-105 text-sm text-white font-semibold border border-white/20 hover:border-purple-500/50"
                            >
                                <Github size={18} />
                                View on GitHub
                            </a>
